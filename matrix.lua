...
local numfill = function( _,start,stop,idp )
	...
	--return love.math.random( start,stop ) / idp
end
local tfill = function( t,start,stop,idp )
	for i in ipairs(t) do
		t[i] = math.random( start,stop ) / idp
		--t[i] = love.math.random( start,stop ) / idp
	end
	return t
end
...
--[[This one is broken...it checks the columns and rows backwards. Use the one below.
